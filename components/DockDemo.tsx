...
export function DockDemo({ addSpreadsheetNode, addChatbotNode, addContextNode }: DockDemoProps) {
  return (
    <div className="relative">
      <Dock magnification={60} distance={100}>
        ...
        >
          <Icons.googleSpreadsheet className="size-full" />
        </DockIcon>
...
const Icons = {
  googleSpreadsheet: (props: IconProps) => (
    <svg
    ...
    >
      ...
      <path
        fill="#e8f5e9"
        d="M31,23H17h-2v2v2v2v2v2v2v2h18v-2v-2v-2v-2v-2v-2v-2H31z 
           M17,25h4v2h-4V25z 
           M17,29h4v2h-4V29z 
           M17,33h4v2h-4V33z 
           M31,35h-8v-2h8V35z 
